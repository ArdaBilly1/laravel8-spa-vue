...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetch: function fetch() {
      ...
      axios.get('/api/libraies').then(function (_ref) {
        var data = _ref.data;
        //console.log(data);
        _this.paginator = data.paginator;
        _this.itemProducts = data.data;
    ...
    destroy: function destroy(id, index) {
      ...
      if (confirm("Apakah Anda Yakin ?")) {
        this.pending = true; // axios.delete('/api/product-items/'+id,this.config)

        axios["delete"]('/api/libraries/' + id).then(function (_ref2) {
          var data = _ref2.data;

          if (data.error == false) {
            _this2.$store.dispatch("success", data.message).then(function () {
              _this2.$delete(_this2.itemProducts, index);
            });
          } else {
            alert(data.message);
          }
          ...
          _c("div", { staticClass: "col-12" }, [
            ...
            _c("div", { staticClass: "card" }, [
                ...
                [
                  _c(
                    "router-link",
                    {
                      ...
                      attrs: { to: { name: "item-product-create" } }
                    },
                    [
                    ...
                    _c(
                      ...
                      _vm._l(_vm.libraries, function(library, index) {
                        return _c("tr", { key: library.id }, [
                          _c("td", [_vm._v(_vm._s(library.id))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(library.nama_buku))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(library.penerbit))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(library.status))]),
                          _vm._v(" "),
                          _c(
                            "td",
                            [
                                ...
                                "button",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.destroy(library.id, index)
                                    }
                                  }
                                },
                                [
              ...
              _c(
                ...
                [
                  _c("pagination", {
                    attrs: { pagination: _vm.paginator },
                    on: {
      ...
      _c("div", { staticClass: "container-fluid" }, [
        _c("div", { staticClass: "row mb-2" }, [
          _c("div", { staticClass: "col-sm-6" }, [
            _c("h1", { staticClass: "m-0 text-dark" }, [_vm._v("Daftar Buku")])
          ])
        ])
      ])
    ])
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", [_vm._v("id")]),
        _vm._v(" "),
        _c("th", [_vm._v("Nama Buku")]),
        _vm._v(" "),
        _c("th", [_vm._v("Penerbit")]),
        _vm._v(" "),
        _c("th", [_vm._v("Status")]),
        _vm._v(" "),
        _c("th", [_vm._v("Aksi")])
...
__webpack_require__(/*! E:\Laravel\laravel8-spa-vue\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\Laravel\laravel8-spa-vue\resources\css\app.css */"./resources/css/app.css");
